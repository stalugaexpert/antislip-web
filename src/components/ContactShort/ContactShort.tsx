...
export const ContactShort = () => {
  ...
  return (
    <section className='px-24 max-w-screen-2xl mx-auto mb-20 h-fit services-xs:mb-12 services-xs:px-14 about-sm:px-10 mission-sm:px-0 mission-sm:mb-0'>
      <div className="flex mission-sm:flex-wrap items-center gap-24 about-md:gap-16 mission-sm:gap-0 h-[70vh]  mission-sm:h-full">
          ...
          <form>
            ...
            <div className="flex items-center mb-6">
              <div className="mr-2">
                ...
                >
                  <input
                    className="peer relative appearance-none w-7 h-7 border rounded-md border-blue-gray-200 cursor-pointer transition-all before:content[''] before:block before:bg-blue-gray-500 before:w-12 before:h-12 before:rounded-full before:absolute before:top-2/4 before:left-2/4 before:-translate-y-2/4 before:-translate-x-2/4 before:opacity-0 hover:before:opacity-10 before:transition-opacity checked:bg-amber600 checked:border-amber600 checked:before:bg-amber600"
                    id="checkbox"
                    type="checkbox"
                  />
            ...
            <button
              className="flex max-w-[200px] cursor-pointer justify-center items-center gap-3 bg-amber600 px-4 py-2.5 mission-sm:p-2 rounded-lg text-neutral50 duration-300 hover:opacity-80 hover:translate-y-1 disabled:hover:opacity-100 disabled:hover:translate-y-0 disabled:cursor-not-allowed"
              disabled={isLoading}
            >
              { isLoading ? (
                <svg
